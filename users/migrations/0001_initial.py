    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.BooleanField(default=False, help_text='Designates whether the user can access admin features.', verbose_name='admin status')),
                ('phone_number', models.CharField(blank=True, help_text='Optional phone number for contact.', max_length=15, null=True, verbose_name='phone number')),
                ('profile_picture', models.ImageField(blank=True, help_text='Optional profile picture.', null=True, upload_to='profile_pics/', verbose_name='profile picture')),
